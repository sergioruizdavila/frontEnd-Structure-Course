    ...
    (function (pages) {
        ...
        (function (logInPage) {
            ...
            var LogInPageController = (function () {
                function LogInPageController(logInPageService, localStorage, $state) {
                ...
                LogInPageController.prototype.logIn = function () {
                    var self = this;
                    this.logInPageService.logIn(this.userData.email, this.userData.password).then(function (response) {
